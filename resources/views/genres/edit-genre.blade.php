<x-standard-layout title="Edit Genre">
    ...
    <form action="{{ route('genres.update', $genre->id) }}" method="POST" class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 w-full max-w-md mx-auto">
        @csrf
        @method('PUT') <!-- Use PUT method for updating -->

        <!-- Name input -->
        <div class="mb-4">
            <label for="name" class="block text-gray-700 dark:text-gray-300 text-xl font-bold mb-2">Genre Name:</label>
